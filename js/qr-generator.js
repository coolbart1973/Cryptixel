    ...
    showLoading(container) {
        container.innerHTML = `
            <div class="loading-container">
                ...
                <p class="loading-text">Encrypting and generating your Visual QR...</p>
            </div>
        `;
...
window.VisualQRGenerator = VisualQRGenerator;
window.VisualQRScanner = VisualQRScanner;
