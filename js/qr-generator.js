// Cryptixel QR Code Generator
class CryptixelGenerator {
    constructor() {
    ...
    showLoading(container) {
        container.innerHTML = `
            <div class="loading-container">
                ...
                <p class="loading-text">Encrypting and generating your Cryptixel QR...</p>
            </div>
        `;
...
window.CryptixelGenerator = CryptixelGenerator;
window.CryptixelScanner = CryptixelScanner;
